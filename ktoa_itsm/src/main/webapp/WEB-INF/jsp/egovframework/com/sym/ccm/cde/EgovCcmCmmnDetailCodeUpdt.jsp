...
function fn_egov_init(){
	// 첫 입력란에 포커스..
	document.getElementById("cmmnDetailCodeVO").comnCdNm.focus();
}
 ...
 ******************************************************** */
function selectList(){
	var objForm = document.getElementById("cmmnDetailCodeForm");
...
<!-- 상단타이틀 -->
<form:form commandName="cmmnDetailCodeVO" id="cmmnDetailCodeForm" action="${pageContext.request.contextPath}/sym/ccm/cde/UpdateCcmCmmnDetailCode.do" method="post" onSubmit="fn_egov_updt_code(document.forms[0]); return false;">  
...
<%-- <div class="wTableFrm">
	...
	<tbody>
		...
		<tr>
			...
			<td class="left">
			    <form:input path="comnCdId" title="${title} ${inputTxt}" readonly="true"/>
		...
		<tr>
			...
			<td class="left">
			    <form:input path="comnCd" title="${title} ${inputTxt}" size="70" maxlength="10" readonly="true" />
