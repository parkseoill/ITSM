...
<%--
 /**
  * @Class Name : PartnersMngRegistPopup.jsp
  * @Description : 방문자 등록 화면
  * @Modification Information
  * @
  * @ 수정일               수정자             수정내용
  * @ ----------   --------   ---------------------------
  * @ 2022.10.05   이유리            최초 생성
  *
  *  @author 이유리
  *  @since 2022.10.05
  *  @version 1.0
...
<form:form commandName="chargerVO" id="partnersMngForm" name="partnersMngForm" method="post" action="${pageContext.request.contextPath}/sys/ptn/insertPartnersMngRegistPopup.do">
<div class="wTableFrm">
...
<h2>방문자 등록</h2>
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
			    <form:input path="chrgrNm" id="chrgrNm" maxlength="10" title="담당자명" cssStyle="width:100px" />
	...
	<!-- 하단 버튼 -->
	<div class="btn">
			<input class="s_submit" type="submit" value='<spring:message code="button.create" />' onclick="checkVisitor(); return false;" /><!-- 등록 -->
	</div>
