...
public class EgovRoleManageController {
	 ...
	 * @param comnCdId String
	 * @return List
	 * @exception Exception
	 */
    public List<?> getCmmCodeDetailList(ComDefaultCodeVO comDefaultCodeVO, String comnCdId)  throws Exception {
    	comDefaultCodeVO.setComnCdId(comnCdId);
