...
public class DeptManageDAO extends EgovComAbstractDAO {
	...
	public List<DeptManageVO> selectDeptManageListPopUp(DeptManageVO deptManageVO) throws Exception {
		return selectList("deptManageDAO.selectDeptManageListPopUp", deptManageVO);
	}
    ...
    /**
   	 ...
   	 * @param deptManageVO - 부서 Vo
   	 * @return int - 부서 카운트 수
   	 * @exception ExceptionselectDeptManageListPopUpTotCnt
   	 */
       public int selectDeptManageListPopUpTotCnt(DeptManageVO deptManageVO) throws Exception {
           return (Integer)selectOne("deptManageDAO.selectDeptManageListPopUpTotCnt", deptManageVO);
       }
