...
<%
 /**
  * @Class Name : RepoVisitMngList.jsp
  * @Description : 출입방문자 보고서
  * @Modification Information
  * @
  * @  수정일             수정자             수정내용
  * @ ----------   --------   ---------------------------
  * @ 2022.08.03   이태신            최초 생성
  *
  *  @author 이태신
  *  @since 2022.08.03
  *  @version 1.0
...
<script type="text/javascript">
	...
	// 리포트 생성 및 출력
	function fn_jrView(){
		const jrXmlFilePathAdd = "truebon/com/dlm/vis/";	// jrxml 파일 경로 sub
		const jrFileNm = "visitReport";	// jrxml, 기타 파일 명
		const jrServiceNm = "selectVisitList";	// DB 서비스 사용 시 등록
...
<div class="board">
	<h1>방문자출입관리 보고서</h1>
	<!-- 달력 -->
	<input name="startDate" id="startDate" type="text"  value="" style="width:80px" />
				~	<input name="endDate" id="endDate" type="text"  value="" style="width:80px" />&emsp;&emsp;&emsp;
	<!-- 버튼 -->
	<div class="btn">
