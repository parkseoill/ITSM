...
<div class="wTableFrm">
	<div style="float:left; width:50%;">
		<div style="padding-right:3%">
			...
			<!-- 하단 버튼 -->
			<div class="btn">
				<span class="btn_s2"><a href="#LINK" onclick="startCamera(); return false;" title="카메라 실행">카메라 실행</a></span><!-- 카메라 실행 -->
				<span class="btn_s2"><a href="#LINK" onclick="stopCamera(); return false;" title="카메라 종료">카메라 종료</a></span><!-- 카메라 종료 -->
			</div>
		</div>
	</div>
	<div style="float:right; width:50%;">
        ...
        <!-- 하단 버튼 -->
		<div class="btn">
			<span class="btn_s2"><a href="#LINK" onclick="moveDlalzLe(); return false;" title="퇴근화면 이동">퇴근화면 이동</a></span>
			...
			<span class="btn_s2" ><a href="#LINK" onclick="moveVisitQRMain(); return false;" title='메인 페이지'>메인 페이지</a></span>
			</c:if>
		</div>
	</div>
