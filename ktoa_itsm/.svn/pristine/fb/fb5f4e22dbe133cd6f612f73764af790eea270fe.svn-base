...
//		return "egovframework/com/uss/umt/EgovDeptManageList";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/uss/umt/dpt/selectDeptManageListPopup.do")
	public String selectDeptManageListPopup(@ModelAttribute("deptManageVO") DeptManageVO deptManageVO, ModelMap model) throws Exception {
		...
		model.addAttribute("deptManageList", egovDeptManageService.selectDeptManageListPopUp(deptManageVO));

		int totCnt = egovDeptManageService.selectDeptManageListPopUpTotCnt(deptManageVO);
		paginationInfo.setTotalRecordCount(totCnt);
		model.addAttribute("paginationInfo", paginationInfo);
		model.addAttribute("deptGubun", deptManageVO.getDeptGubun());
		return "egovframework/com/uss/umt/EgovDeptManageListPopup";
	}
	...
	public String selectDeptManage(@RequestParam("deptNo") String deptNo,
									@RequestParam("cmpnyNo") String cmpnyNo,
									@ModelAttribute("deptManageVO") DeptManageVO deptManageVO, ModelMap model) throws Exception {

		deptManageVO.setDeptNo(deptNo);
		deptManageVO.setCmpnyNo(cmpnyNo);
